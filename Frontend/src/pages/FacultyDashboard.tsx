...
function FacultyDashboard() {
  ...
  const {userInfo , setUserInfo , showCompleteProfile , setShowCompleteProfile} = useContext(UserContext);
...
const getRoleBasedProfile = async (userData: unknown) => {
  ...
  return (
    <div className="h-screen w-full ">
       {
         showCompleteProfile ? <FacultyCompleteProfileModal /> :  <div className="h-[100%] w-[100%]">
         ...
         <div className="flex ">
            <FacultyDashboardSideBar/>
             ...
             <div className=" h-screen w-[100%]">
                   ...
                   { locationPath == "/facultyDashboard/addCodingQuestion" && <AddCodingQuestion />}
                   { locationPath == "/facultyDashboard/createCodingTest" && <CreateCodingTest />}
                   { locationPath == "/facultyDashboard/addMCQQuestion" && <AddMCQQuestion />}
                   { locationPath == "/facultyDashboard/createMCQTest" && <CreateMCQTest />}
